...
ES6为`new`命令引入了一个`new.target`属性，（在构造函数中）返回`new`命令作用于的那个构造函数。
...
---
 ...
 阅读(17.9k) [ 书签](javascript:;) [ 赞(6)](javascript:;) [ 分享](javascript:;) [ 我要纠错](https://www.w3cschool.cn/edit/ecmascript/e7yk1q5x)

# ECMAScript 6 Class

2018-09-20 17:18 更新

1. [Class基本语法](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#Class基本语法)
2. [Class的继承](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#Class的继承)
3. [原生构造函数的继承](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#原生构造函数的继承)
4. [Class的取值函数（getter）和存值函数（setter）](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#Class的取值函数（getter）和存值函数（setter）)
5. [Class的Generator方法](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#Class的Generator方法)
6. [Class的静态方法](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#Class的静态方法)
7. [Class的静态属性和实例属性](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#Class的静态属性和实例属性)
8. [new.target属性](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#new.target属性)
9. [Mixin模式的实现](https://www.w3cschool.cn/ecmascript/e7yk1q5x.html#Mixin模式的实现)
